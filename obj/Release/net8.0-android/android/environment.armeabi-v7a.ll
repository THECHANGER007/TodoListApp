...
@dso_cache = dso_local local_unnamed_addr global [658 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 158860561, ; hash 0x9780511, from name: aot-TodoListApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 363018393, ; hash 0x15a33899, from name: TodoListApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TodoListApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 57
	...
	%struct.DSOCacheEntry {
		i64 500248558, ; hash 0x1dd12fee, from name: libaot-TodoListApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TodoListApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 78
	...
	%struct.DSOCacheEntry {
		i64 640917248, ; hash 0x26339f00, from name: TodoListApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TodoListApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 96
	...
	%struct.DSOCacheEntry {
		i64 2729188291, ; hash 0xa2ac1bc3, from name: aot-TodoListApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TodoListApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 421
	...
	%struct.DSOCacheEntry {
		i64 3598984535, ; hash 0xd6842557, from name: libaot-TodoListApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TodoListApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 550
